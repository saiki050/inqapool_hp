...
export const Hero: React.FC = () => {
  return (
    <section className="min-h-screen flex flex-col lg:flex-row pt-52 pb-32 px-10 md:px-20 lg:px-28 gap-20 lg:gap-32 items-start justify-between relative">
      ...
      <div className="w-full lg:w-[40%] flex flex-col gap-20 relative z-10">
        {/* メインイメージ */}
        <div className="w-full aspect-[14/10] overflow-hidden grayscale bg-neutral-300 shadow-2xl">
          <img 
        ...
        {/* 詳細イメージ：枠線を少し細くし、より建築的な画像へ */}
        <div className="w-full aspect-[14/10] overflow-hidden border-[1px] border-[#a78bfa] p-4 grayscale bg-neutral-300">
          <div className="w-full h-full overflow-hidden">
            <img 
              src="https://images.unsplash.com/photo-1518005020453-103360b0f443?q=80&w=1200" 
